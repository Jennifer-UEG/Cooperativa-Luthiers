...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Registre a entrada de um instrumento na oficina para reparo   ' }),
    (0, swagger_1.ApiBody)({ type: create_instrumento_dto_1.CreateInstrumentoDto }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Lista todos os instrumentos em manutenção na oficina' }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiParam)({ name: 'id', example: 1, description: 'ID do instrumento' }),
    (0, swagger_1.ApiOperation)({ summary: 'Busca instrumento por id' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', example: 1, description: 'ID do instrumento' }),
    (0, swagger_1.ApiOperation)({ summary: 'Marca o reparo de um instrumento como concluído' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Remove o registro de um instrumento' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
